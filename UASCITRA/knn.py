...
if __name__ == "__main__":
    input_path = "c:/Campus Life/Semester 4/Pengolahan Citra/UASCITRA/image.jpeg"  # Ganti dengan path gambar input Anda
    output_directory = "c:/Campus Life/Semester 4/Pengolahan Citra/UASCITRA/Output/"  # Ganti dengan direktori untuk menyimpan gambar hasil
    
    if not os.path.exists(output_directory):
        os.makedirs(output_directory)
    
    output_path = os.path.join(output_directory, "output_image.jpeg")  # Nama file output
